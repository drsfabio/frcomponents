...
uses
  FRMaterial3Base, FRMaterialTheme, FRMaterialFieldPainter, Classes, Controls, ExtCtrls, Forms, Graphics, Math,
...
begin
  ...
  FDisplayEdit.BorderSpacing.Left   := MD3_FIELD_PADDING_H;
